...
(function() {
  var Match, Neo4jCursor, Neo4jData, Neo4jNode, Neo4jRelationship, check, events, _, __wait, __error, _ref, _ref1,
      ...
      return {
        ...
        delete: function(names) {
          ...
          return self.__return(function(fut) {
            ...
            if (_.isString(names)) {
              if ((_ref2 = self._node) != null ? _ref2[names] : void 0) {
              ...
              for (_i = 0, _len = names.length; _i < _len; _i++) {
                name = names[_i];
                if ((_ref3 = self._node) != null ? _ref3[name] : void 0) {
                  delete self._node[name];
                  tasks.push({
                    method: 'DELETE',
                    to: self._service.property.endpoint.replace('{key}', name)
                  });
              ...
              _ref4 = _.omit(self._node, ['_service', 'id', 'labels', 'metadata']);
              for (n in _ref4) {
                v = _ref4[n];
                delete self._node[n];
              }
