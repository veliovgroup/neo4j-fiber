    ...
    get: function(name) {
      ...
      return self.__return(function(fut) {
        ...
        if (!name) {
          ...
          return fut.return(self._node[name]);
        }
      });
    },
      ...
      return self.__return(function(fut) {
        ...
        if (_.isString(labels)) {
          ...
          if (labels.length > 0) {
            for (_i = 0, _len = labels.length; _i < _len; _i++) {
              label = labels[_i];
              self._node.metadata.labels.push(label);
            }
            self._db.__batch({
              method: 'POST',
              to: self._service.labels.endpoint,
      ...
      return self.__return(function(fut) {
        ...
        if (_.isString(labels)) {
          ...
          labels = (function() {
            ...
            for (_i = 0, _len = labels.length; _i < _len; _i++) {
              label = labels[_i];
              if (label.length > 0 && !!~self._node.metadata.labels.indexOf(label)) {
                _results.push(label);
              }
            }
            return _results;
          ...
          if (labels.length > 0) {
            ...
            for (_i = 0, _len = labels.length; _i < _len; _i++) {
              label = labels[_i];
              self._node.metadata.labels.splice(self._node.metadata.labels.indexOf(label), 1);
              tasks.push({
                method: 'DELETE',
                to: self._service.labels.endpoint + '/' + label
              });
            }
            self._db.batch(tasks, {
              plain: true
