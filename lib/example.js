...
(function() {
  ...
  Fiber(function() {
    ...
    result = t.commit();
    console.log(db.queryOne("MATCH (n:TransactionsTesting) RETURN n").n === result[0].fetch()[0].n);
    console.log(db.queryOne("MATCH (n:TransactionsTesting2) RETURN n").n === result[1].fetch()[0].n);
    ...
    return console.log(db.queryOne("MATCH (n:TransactionsTesting2) RETURN n") === void 0);
  }).run();
