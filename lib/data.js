...
(function() {
  ...
  module.exports = Neo4jData = (function() {
    ...
    Neo4jData.prototype.__refresh = function() {
      return this._expire = (+(new Date)) + this._expiration * 1000;
    };
    ...
    Neo4jData.define('node', {
      ...
      set: function(value) {
        var v1, v2, _ref;
        if ((_ref = this._node) != null ? _ref._service : void 0) {
        ...
        if (value != null ? value._service : void 0) {
          v2 = _.clone(value);
          delete v2._service;
